...
public class  Piece extends StackPane {
    ...
    public Piece(PieceType type, int x, int y) {
        ...
        if (LoginWindow.colorPicker1.getValue().equals(Color.valueOf("#ffffff")) &&
            LoginWindow.colorPicker2.getValue().equals(Color.valueOf("#ffffff"))) {
            ellipse.setFill(type == PieceType.RED ? Color.RED : Color.WHITE);
        } else {
            ellipse.setFill(type == PieceType.RED ? LoginWindow.colorPicker1.getValue() : LoginWindow.colorPicker2.getValue());
        }
